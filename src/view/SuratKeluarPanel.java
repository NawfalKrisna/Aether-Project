...
public class SuratKeluarPanel extends JPanel {
        ...
        private void initUI() {
                ...
                searchField.setToolTipText("Cari surat keluar...");
                                ...
                                if (e.isPopupTrigger() || SwingUtilities.isRightMouseButton(e)) {
                                        ...
                                        if (row >= 0) {
                                                ...
                                                edit.addActionListener(ae -> {
                                                        ...
                                                        try {
                                                                Date tanggal = new SimpleDateFormat("dd/MM/yyyy")
                                                                                .parse(tanggalStr);
                                                                model.SuratKeluar surat = new model.SuratKeluar(id,
                                                                                nomor, tanggal, perihal, penerima,
                                                                                filePath);
                                                                Frame frame = (Frame) SwingUtilities.getWindowAncestor(
                                                                                SuratKeluarPanel.this);
                                                                TambahSuratKeluarDialog dialog = new TambahSuratKeluarDialog(
                                                                                frame, surat);
                                                                dialog.setVisible(true);
                                                                loadData();
                                                                if (frame instanceof DashboardFrame) {
                                                ...
                                                del.addActionListener(ae -> {
                                                        String id = String.valueOf(model.getValueAt(row, 0));
                                                        int conf = JOptionPane.showConfirmDialog(SuratKeluarPanel.this,
        ...
        private void loadData() {
                ...
                List<SuratKeluar> list = dao.getAll();
                                ...
                                try {
                                        ...
                                        if ("Edit".equals(label)) {
                                                ...
                                                java.util.Date tanggal = new SimpleDateFormat("dd/MM/yyyy")
                                                                .parse(tanggalStr);
                                                model.SuratKeluar surat = new model.SuratKeluar(id, nomor, tanggal,
                                                                perihal, penerima, filePath);
                                                Frame frame = (Frame) SwingUtilities
                                                                .getWindowAncestor(SuratKeluarPanel.this);
                                                TambahSuratKeluarDialog dialog = new TambahSuratKeluarDialog(frame,
                                                                surat);
                                                dialog.setVisible(true);
                                                loadData();
